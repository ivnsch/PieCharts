...
class CustomViewsDemoEdgeCase: UIViewController, PieChartDelegate {
    ...
    fileprivate func createModels() -> [PieSliceModel] {
        ...
        let slices: [PieSliceModel] = [
            ...
            PieSliceModel(value: 94, color: UIColor.orange.withAlphaComponent(alpha))
        ]
        return slices
    }
